        ...
        <div class="marks form content">
            ...
            <fieldset>
                ...
                <?php
                    ...
                    echo $this->Form->control('term1_subject_8');
                    echo $this->Form->control('term1_subject_8_periodic_test');
                    echo $this->Form->control('term1_subject_8_subject_enrichment');
                    echo $this->Form->control('term1_subject_8_multiple_assessment');
                    echo $this->Form->control('term1_subject_8_portfolio');
                    echo $this->Form->control('term1_subject_8_total');
                    echo $this->Form->control('term1_subject_8_grade');
                    echo $this->Form->control('term2_subject_8');
                    echo $this->Form->control('term2_subject_8_periodic_test');
                    echo $this->Form->control('term2_subject_8_subject_enrichment');
                    echo $this->Form->control('term2_subject_8_multiple_assessment');
                    echo $this->Form->control('term2_subject_8_portfolio');
                    echo $this->Form->control('term2_subject_8_total');
                    echo $this->Form->control('term2_subject_8_grade');
                    echo $this->Form->control('term1_subject_9');
                    echo $this->Form->control('term1_subject_9_periodic_test');
                    echo $this->Form->control('term1_subject_9_subject_enrichment');
                    echo $this->Form->control('term1_subject_9_multiple_assessment');
                    echo $this->Form->control('term1_subject_9_portfolio');
                    echo $this->Form->control('term1_subject_9_total');
                    echo $this->Form->control('term1_subject_9_grade');
                    echo $this->Form->control('term2_subject_9');
                    echo $this->Form->control('term2_subject_9_periodic_test');
                    echo $this->Form->control('term2_subject_9_subject_enrichment');
                    echo $this->Form->control('term2_subject_9_multiple_assessment');
                    echo $this->Form->control('term2_subject_9_portfolio');
                    echo $this->Form->control('term2_subject_9_total');
                    echo $this->Form->control('term2_subject_9_grade');
                    echo $this->Form->control('term2_total');
                    echo $this->Form->control('term1_subject_1_ct');
                    echo $this->Form->control('term1_subject_2_ct');
                    echo $this->Form->control('term1_subject_3_ct');
                    echo $this->Form->control('term1_subject_4_ct');
                    echo $this->Form->control('term1_subject_5_ct');
                    echo $this->Form->control('term1_subject_6_ct');
                    echo $this->Form->control('term1_subject_7_ct');
                    echo $this->Form->control('term1_subject_8_ct');
                    echo $this->Form->control('term1_subject_9_ct');
                    echo $this->Form->control('term2_subject_1_ct');
                    echo $this->Form->control('term2_subject_2_ct');
                    echo $this->Form->control('term2_subject_3_ct');
                    echo $this->Form->control('term2_subject_4_ct');
                    echo $this->Form->control('term2_subject_5_ct');
                    echo $this->Form->control('term2_subject_6_ct');
                    echo $this->Form->control('term2_subject_7_ct');
                    echo $this->Form->control('term2_subject_8_ct');
                    echo $this->Form->control('term2_subject_9_ct');
                ?>
            </fieldset>
