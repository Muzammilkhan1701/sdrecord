                    ...
                    <div class="card mb-5">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#subjectsAccordion">
                            <div class="card-body">
                                <!-- Fields for Term 1 -->
                                <div class="term1-fields">
                                    <?= $this->Form->control('term1_subject_3', ['label' => 'Exam Marks (Term 1)','max' =>80]) ?>
                        ...
                        <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#subjectsAccordion">
                            <div class="card-body">
                                ...
                                <div class="term1-fields">
                                    ...
                                    <?= $this->Form->control('term1_subject_7_periodic_test', ['label' => 'Periodic Test (Term 1)','max' =>5, 'required' => true,]) ?>
                                ...
                                <div class="term2-fields">
                                    ...
                                    <?= $this->Form->control('term2_subject_7_periodic_test', ['label' => 'Periodic Test (Term 2)','max' =>5, 'required' => true,]) ?>
